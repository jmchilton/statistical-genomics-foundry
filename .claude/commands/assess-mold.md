...
argument-hint: "<mold> (a content/molds/<slug> path or Mold slug)"
allowed-tools: Read, Write, Edit, Bash, WebFetch, WebSearch, Agent
---

# /assess-mold

Grade one canonical **Foundry Mold** under `content/molds/<slug>/` across the four
...
`$ARGUMENTS` = the Mold: a `content/molds/<slug>` path or a slug to
