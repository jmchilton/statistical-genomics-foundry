...
Read: `content/meta/glossary.md` (vocabulary authority), `content/meta/mold-spec.md` (the Mold contract you'll
...
reuse/new/re-summarize) + `content/meta/mold-spec.md` + `content/meta/glossary.md` + `content/meta/referee-loop.md` + the
`content/meta/molds.md` naming convention. **It must NOT see the SKILL.md** — this holds for the doer too;
